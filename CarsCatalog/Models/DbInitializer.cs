...
{
    public class CatalogDbInitializer : DropCreateDatabaseAlways<CatalogDbContext>
    {
        protected override void Seed(CatalogDbContext context)
        {
            ...
            context.Cars.Add(new Car() { Price = 12000, EngineCapacity = "2.5", Color = "Black", ModelId = 2 });
            context.Cars.Add(new Car() { Price = 12100, EngineCapacity = "2.5", Color = "Black", ModelId = 3 });
            context.Cars.Add(new Car() { Price = 12200, EngineCapacity = "1.5", Color = "White", ModelId = 14 });
            context.Cars.Add(new Car() { Price = 12300, EngineCapacity = "2.4", Color = "Red", ModelId = 2 });
            context.Cars.Add(new Car() { Price = 12400, EngineCapacity = "1.6", Color = "Blue", ModelId = 2 });
            context.Cars.Add(new Car() { Price = 7500, EngineCapacity = "2.5", Color = "Blue", ModelId = 13 });
            context.Cars.Add(new Car() { Price = 4500, EngineCapacity = "2.5", Color = "Blue", ModelId = 7 });
